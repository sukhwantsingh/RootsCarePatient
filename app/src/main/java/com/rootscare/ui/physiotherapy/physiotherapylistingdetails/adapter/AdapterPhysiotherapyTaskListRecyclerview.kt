package com.rootscare.ui.physiotherapy.physiotherapylistingdetails.adapter
...
class AdapterPhysiotherapyTaskListRecyclerview(
    val departmentList: ArrayList<ResultItem?>?,
    internal var context: Context
) : RecyclerView.Adapter<AdapterPhysiotherapyTaskListRecyclerview.ViewHolder>() {
...
//        return 3
    ...
    inner class ViewHolder(itemView: ItemDoctorldetailsSpecilitylistRecyclerviewBinding) :
        ...
        fun onBind(pos: Int) {
            Log.d(TAG, " true")
            localPosition = pos
            itemView.rootView?.txt_doctordetails_specility?.text = departmentList?.get(pos)?.name
