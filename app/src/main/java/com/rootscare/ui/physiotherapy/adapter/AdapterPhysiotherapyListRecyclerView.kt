...
import com.rootscare.databinding.ItemSeeAllPhysiotherapyListRecyclerviewBinding
...
import kotlinx.android.synthetic.main.item_see_all_physiotherapy_list_recyclerview.view.*

class AdapterPhysiotherapyListRecyclerView ( internal var context: Context) : RecyclerView.Adapter<AdapterPhysiotherapyListRecyclerView.ViewHolder>() {
...
//
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val singleItemDashboardListingBinding = DataBindingUtil.inflate<ItemSeeAllPhysiotherapyListRecyclerviewBinding>(
            LayoutInflater.from(context),
            R.layout.item_see_all_physiotherapy_list_recyclerview, parent, false)
...
//        return trainerList!!.size
    ...
    inner class ViewHolder(itemView: ItemSeeAllPhysiotherapyListRecyclerviewBinding) : RecyclerView.ViewHolder(itemView.root) {
...
//            })
            itemView?.root?.crdview_seeall_physiotherapylisting?.setOnClickListener(View.OnClickListener {
