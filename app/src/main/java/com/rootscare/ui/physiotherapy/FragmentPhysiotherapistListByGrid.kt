...
import com.rootscare.ui.physiotherapy.adapter.AdapterSeeAllPhysiotherapistByGridRecyclerView
...
class FragmentPhysiotherapistListByGrid :
    BaseFragment<FragmentSeeAllNursesListByGridBinding, FragmentPhysiotherapistListByGridViewModel>(),
    FragmentPhysiotherapistListByGridNavigator {
    private var fragmentSeeAllNursesListByGridBinding: FragmentSeeAllNursesListByGridBinding? = null
    private var fragmentNursesListByGridViewModel: FragmentPhysiotherapistListByGridViewModel? =
        null
    ...
    override val viewModel: FragmentPhysiotherapistListByGridViewModel
        get() {
            fragmentNursesListByGridViewModel =
                ViewModelProviders.of(this)
                    .get(FragmentPhysiotherapistListByGridViewModel::class.java)
            return fragmentNursesListByGridViewModel as FragmentPhysiotherapistListByGridViewModel
        }

    companion object {
        fun newInstance(): FragmentPhysiotherapistListByGrid {
            val args = Bundle()
            val fragment = FragmentPhysiotherapistListByGrid()
            fragment.arguments = args
            return fragment
        }

//        fun newInstance(userType: String): FragmentPhysiotherapistListByGrid {
//            val args = Bundle()
...
//        }
        ...
        fragmentSeeAllNursesListByGridBinding?.edtNurseSearchByName?.setText("Search by physiotherapist name")
        fragmentSeeAllNursesListByGridBinding?.llMain?.setOnClickListener {
...
//        fragmentSeeAllNursesListByGridBinding?.btnRootscareMoreNurses?.setOnClickListener {
...
//        }
        ...
        fragmentSeeAllNursesListByGridBinding?.ivChangeView?.setOnClickListener {
            ...
            if (fragmentSeeAllNursesListByGridBinding!!.recyclerViewRootscareSeeallnursesByGrid.adapter != null) {
                ...
                (fragmentSeeAllNursesListByGridBinding!!.recyclerViewRootscareSeeallnursesByGrid.adapter as
                        AdapterSeeAllPhysiotherapistByGridRecyclerView).setType(isGrid)
            }
        }
...
//        val contactListAdapter = AdapterHospitalRecyclerview(trainerList,context!!)
        val contactListAdapter =
            AdapterSeeAllPhysiotherapistByGridRecyclerView(nurseList, requireContext(), isGrid)
...
//            dataList.addFirst(SihatkuSpecialitiesSubModel(SpecialityName = resources.getString(R.string.unselect)))
            val spinnerAdapter =
                CustomDropDownAdapter(requireContext(), departmentDropdownList!!)
