...
import com.rootscare.ui.bookingappointment.FragmentBookingAppointmentNavigator
import io.reactivex.disposables.Disposable
import okhttp3.MultipartBody
import okhttp3.RequestBody

class FragmentAddPatientForDoctorBookingViewModel :
    BaseViewModel<FragmentAddPatientForDoctorBookingNavigator>() {
...
//        val body = RequestBody.create(MediaType.parse("application/json"), "")
        ...
        if (image != null) {
//            email,phone_number
            disposable = apiServiceWithGsonFactory.apiinsertpatientfamily(
                userId,
                first_name,
                last_name,
                image,
