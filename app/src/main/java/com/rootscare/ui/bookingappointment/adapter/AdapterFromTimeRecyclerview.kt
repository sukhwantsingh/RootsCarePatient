...
class AdapterFromTimeRecyclerview ( internal var context: Context) : RecyclerView.Adapter<AdapterFromTimeRecyclerview.ViewHolder>() {
...
//
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val singleItemDashboardListingBinding = DataBindingUtil.inflate<ItemFromTimeRecyclerviewBinding>(
            LayoutInflater.from(context),
            R.layout.item_from_time_recyclerview, parent, false)
...
//        return trainerList!!.size
    ...
    inner class ViewHolder(itemView: ItemFromTimeRecyclerviewBinding) : RecyclerView.ViewHolder(itemView.root) {
