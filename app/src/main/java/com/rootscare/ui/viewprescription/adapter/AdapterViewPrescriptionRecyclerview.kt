...
class AdapterViewPrescriptionRecyclerview(
    val prescriptionList: ArrayList<ResultItem?>?,
    internal var context: Context
) : RecyclerView.Adapter<AdapterViewPrescriptionRecyclerview.ViewHolder>() {
...
//
            ...
            if (prescriptionList?.get(localPosition)?.ePrescription?.toLowerCase(Locale.ROOT)!!
                    .contains("pdf")
            ) {
                ...
                itemView.root.crdview_view_prescription?.setOnClickListener {
                    AnimUtils.animateIntent(
                        ...
                        TransaprentPopUpActivityForImageShow.newIntent(
                            context as HomeActivity,
                            BaseMediaUrls.USERIMAGE.url + prescriptionList[localPosition]?.ePrescription!!,
                            "pdf"
                        ),
        ...
        fun onBind(pos: Int) {
            ...
            if (prescriptionList?.get(pos)?.prescriptionNumber != null && !prescriptionList.get(pos)?.prescriptionNumber.equals(
                ...
                itemView.txt_description?.text = prescriptionList[pos]?.prescriptionNumber
            } else {
            ...
            if (prescriptionList?.get(pos)?.createdDate != null && !prescriptionList[pos]?.createdDate.equals(
                ...
                itemView.txt_prescription_date?.text = formatDateFromString(
                    ...
                    prescriptionList.get(pos)?.createdDate
                )
            } else {
