...
//            .setSdkLanguage(getAppLocale())
            .setHeaderFont(Typeface.createFromAsset(requireActivity().assets,"font/rubik_regular.ttf"))
           ...
           .setCardInputFont(Typeface.createFromAsset(requireActivity().assets,"font/rubik_regular.ttf"))
           ...
           .setPayButtonFont(Typeface.createFromAsset(requireActivity().assets,"font/rubik_regular.ttf"))
