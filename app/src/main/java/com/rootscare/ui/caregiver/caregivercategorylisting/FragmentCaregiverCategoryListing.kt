...
class FragmentCaregiverCategoryListing :
    BaseFragment<FragmentCaregiverCategorylistingBinding, FragmentCaregiverCategoryListingViewModel>(),
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fragmentCaregiverCategoryListingBinding?.txtCaregiverFilterCategory?.setOnClickListener {
        ...
        fragmentCaregiverCategoryListingBinding?.edtSearchCaregiverByName?.addTextChangedListener(
            object :
                TextWatcher {
...
//                if(s.toString().length>2){
                    if (isNetworkConnected) {
                        ...
                        nurseSearchByNameRequest.searchContent =
                            fragmentCaregiverCategoryListingBinding?.edtSearchCaregiverByName?.text?.toString()
                        fragmentCaregiverCategoryListingViewModel?.apisearchcaregiver(
                            nurseSearchByNameRequest
                        )
                    }
