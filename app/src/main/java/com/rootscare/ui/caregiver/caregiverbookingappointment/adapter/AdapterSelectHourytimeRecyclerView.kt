...
import com.rootscare.databinding.ItemBookingHourlyTimeRecyclerviewBinding
...
class AdapterSelectHourytimeRecyclerView ( internal var context: Context) : RecyclerView.Adapter<AdapterSelectHourytimeRecyclerView.ViewHolder>() {
...
//
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val singleItemDashboardListingBinding = DataBindingUtil.inflate<ItemBookingHourlyTimeRecyclerviewBinding>(
            LayoutInflater.from(context),
            R.layout.item_booking_hourly_time_recyclerview, parent, false)
...
//        return trainerList!!.size
    ...
    inner class ViewHolder(itemView: ItemBookingHourlyTimeRecyclerviewBinding) : RecyclerView.ViewHolder(itemView.root) {
