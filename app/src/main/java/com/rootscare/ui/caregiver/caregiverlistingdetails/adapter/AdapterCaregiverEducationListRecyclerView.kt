package com.rootscare.ui.nurses.caregiverlistingdetails.adapter
...
class AdapterCaregiverEducationListRecyclerView (val qualificationDataList: ArrayList<QualificationDataItem?>?, internal var context: Context) : RecyclerView.Adapter<AdapterCaregiverEducationListRecyclerView.ViewHolder>() {
