...
class AdapterCaregiverFeesListingRecyclerView(val hourlyRatesList: ArrayList<HourlyRatesItem?>?, internal var context: Context) : RecyclerView.Adapter<AdapterCaregiverFeesListingRecyclerView.ViewHolder>() {
    companion object {
