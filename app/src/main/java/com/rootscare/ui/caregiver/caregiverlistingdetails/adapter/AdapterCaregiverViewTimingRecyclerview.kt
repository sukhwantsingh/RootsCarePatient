...
class AdapterCaregiverViewTimingRecyclerview (val nurseTimingList: ArrayList<ResultItem?>?, internal var context: Context) : RecyclerView.Adapter<AdapterCaregiverViewTimingRecyclerview.ViewHolder>() {
    companion object {
