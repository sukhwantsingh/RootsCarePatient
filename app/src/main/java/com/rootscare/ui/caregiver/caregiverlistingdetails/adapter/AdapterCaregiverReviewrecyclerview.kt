...
class AdapterCaregiverReviewrecyclerview(val reviewRatingList: ArrayList<ReviewRatingItem?>?, internal var context: Context) : RecyclerView.Adapter<AdapterCaregiverReviewrecyclerview.ViewHolder>() {
