...
class FragmentSeeAllDoctorByGrid : BaseFragment<FragmentSeeAllDoctorByGridBinding,
        FragmentSeeAllDoctorByGridViewModel>(), FragmentSeeAllDoctorByGridNavigator {
...
//        }
        ...
        fragmentSeeAllDoctorByGridBinding?.ivChangeView?.setOnClickListener {
            ...
            if (fragmentSeeAllDoctorByGridBinding!!.recyclerViewRootscareSeealldoctorsByGrid.adapter != null) {
                fragmentSeeAllDoctorByGridBinding!!.recyclerViewRootscareSeealldoctorsByGrid.layoutManager =
                    GridLayoutManager(
                        activity, if (isGrid) {
                            2
                        } else {
                ...
                (fragmentSeeAllDoctorByGridBinding!!.recyclerViewRootscareSeealldoctorsByGrid.adapter as AdapterSeeAllDoctorByGridRecyclerView).setType(
                    isGrid
                )
            }
        }
...
//        val gridLayoutManager = GridLayoutManager(activity, 2, GridLayoutManager.VERTICAL, false)
        ...
        val contactListAdapter =
            AdapterSeeAllDoctorByGridRecyclerView(allDoctorList, context!!, isGrid)
