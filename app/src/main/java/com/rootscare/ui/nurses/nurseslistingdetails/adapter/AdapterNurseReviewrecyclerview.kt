...
class AdapterNurseReviewrecyclerview(val reviewRatingList: ArrayList<ReviewRatingItem?>?, internal var context: Context) : RecyclerView.Adapter<AdapterNurseReviewrecyclerview.ViewHolder>() {
