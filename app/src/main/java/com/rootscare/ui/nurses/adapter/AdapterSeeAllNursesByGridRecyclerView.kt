...
class AdapterSeeAllNursesByGridRecyclerView(
...
//        holder.onBind(position)
        when (holder) {
            is AdapterSeeAllNursesByGridRecyclerView.ViewHolderGrid -> holder.onBind(position)
            is AdapterSeeAllNursesByGridRecyclerView.ViewHolderList -> holder.onBind(position)
        }
    }
