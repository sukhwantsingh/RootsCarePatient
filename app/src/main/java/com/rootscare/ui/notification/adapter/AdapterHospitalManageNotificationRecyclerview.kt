package com.rootscare.ui.notification.adapter
...
import com.rootscare.databinding.LayoutItemNewNotificationsBinding
import com.rootscare.ui.notification.models.ModelNotificationResponse
import java.util.*

interface OnNotificationCallback {
    fun onNotificationClick(node: ModelNotificationResponse.Result?, pos: Int)
}

class AdapterHospitalManageNotificationRecyclerview(
    val notificationItemResult: ArrayList<ModelNotificationResponse.Result?>?, internal var context: Context) :
    ...
    inner class ViewHolder(val binding: LayoutItemNewNotificationsBinding) :
        RecyclerView.ViewHolder(binding.root) {

        init {
            binding.cnsNotiRoot.setOnClickListener {
                mCalllback.onNotificationClick(
                    notificationItemResult?.get(absoluteAdapterPosition),
        ...
        fun onBindViews(mData: ModelNotificationResponse.Result?) {
            binding.run {
