...
class AdapterBabySitterEducationListRecyclerView (val qualificationDataList: ArrayList<QualificationDataItem?>?, internal var context: Context) : RecyclerView.Adapter<AdapterBabySitterEducationListRecyclerView.ViewHolder>() {
