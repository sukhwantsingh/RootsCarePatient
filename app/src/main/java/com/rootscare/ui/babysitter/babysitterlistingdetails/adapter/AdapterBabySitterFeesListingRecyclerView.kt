...
class AdapterBabySitterFeesListingRecyclerView(val hourlyRatesList: ArrayList<HourlyRatesItem?>?, internal var context: Context) : RecyclerView.Adapter<AdapterBabySitterFeesListingRecyclerView.ViewHolder>() {
    companion object {
