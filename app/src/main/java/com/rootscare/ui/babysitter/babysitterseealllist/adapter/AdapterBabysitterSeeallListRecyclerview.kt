package com.rootscare.ui.babysitter.babysitterseealllist.adapter
...
import com.rootscare.databinding.ItemSeeAllBabysitterListRecyclerviewBinding
...
class AdapterBabysitterSeeallListRecyclerview ( internal var context: Context) : RecyclerView.Adapter<AdapterBabysitterSeeallListRecyclerview.ViewHolder>() {
...
//
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val singleItemDashboardListingBinding = DataBindingUtil.inflate<ItemSeeAllBabysitterListRecyclerviewBinding>(
            LayoutInflater.from(context),
            R.layout.item_see_all_babysitter_list_recyclerview, parent, false)
...
//        return trainerList!!.size
    ...
    inner class ViewHolder(itemView: ItemSeeAllBabysitterListRecyclerviewBinding) : RecyclerView.ViewHolder(itemView.root) {
