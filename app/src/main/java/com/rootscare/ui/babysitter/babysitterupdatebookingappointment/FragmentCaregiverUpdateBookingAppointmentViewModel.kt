...
class FragmentCaregiverUpdateBookingAppointmentViewModel :
    BaseViewModel<FragmentCaregiverUpdateBookingAppointmentNavigator>() {
...
//        val body = RequestBody.create(MediaType.parse("application/json"), "")
        val disposable = apiServiceWithGsonFactory.apibabysitterdetails(nurseDetailsRequest)
            .subscribeOn(_scheduler_io)
            .observeOn(_scheduler_ui)
            .subscribe({ response ->
                if (response != null) {
...
//        val body = RequestBody.create(MediaType.parse("application/json"), "")
        ...
        if (symptom_recording != null) {
            ...
            disposable = apiServiceWithGsonFactory.apiBookCartBabySitter(
                patient_id,
                family_member_id,
                nurse_id,
                from_date,
