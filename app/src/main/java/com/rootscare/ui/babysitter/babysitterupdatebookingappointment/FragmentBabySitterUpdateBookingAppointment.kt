...
import com.rootscare.databinding.FragmentBabysitterUpdateBookingAppointmentBinding
import com.rootscare.ui.babysitter.babysitterupdatebookingappointment.adapter.AdapterForNursesAddPatientListRecyclerview
import com.rootscare.ui.babysitter.babysitterupdatebookingappointment.adapter.AdapterNurseHourlySlotRecycllerview
import com.rootscare.ui.babysitter.babysitterupdatebookingappointment.adapter.AdapterNurseSlotTiimeRecyclerview
...
class FragmentBabySitterUpdateBookingAppointment :
    BaseFragment<FragmentBabysitterUpdateBookingAppointmentBinding, FragmentCaregiverUpdateBookingAppointmentViewModel>(),
    FragmentCaregiverUpdateBookingAppointmentNavigator, GetSlotTimingInterface {
    private var fragmentNursesBookingAppointmentBinding: FragmentBabysitterUpdateBookingAppointmentBinding? =
        null
    ...
    override val layoutId: Int
        get() = R.layout.fragment_babysitter_update_booking_appointment
    ...
    companion object {
        ...
        fun newInstance(nurseid: String): FragmentBabySitterUpdateBookingAppointment {
            val args = Bundle()
            args.putString("nurseid", nurseid)
            val fragment = FragmentBabySitterUpdateBookingAppointment()
...
//                fragmentSeedStockedBinding?.txtLsfSeedstockDateofStocking?.setText("" + year + "-" + monthstr + "-" + dayStr)
                  ...
                  /*  if ((nurseDetailsResponseData?.result?.startTime != null && nurseDetailsResponseData?.result?.startTime != "") &&
                        ...
                        fragmentNursesBookingAppointmentBinding?.tvNoSlots?.visibility =
                            View.VISIBLE
                        fragmentNursesBookingAppointmentBinding?.recyclerViewSlots?.visibility =
                            View.GONE
                    }*/
...
//                ).show()
            ...
            if (nurseVisitPrice != "" && fromBookingTime != "" && toBookingTime != "") {
                ...
                }, "Confirm Appointment", "Are you sure for this babysitter booking ?")
            } else {
                Toast.makeText(
                    activity,
                ...
                if ((nurseDetailsResponseData?.result?.startTime != null && nurseDetailsResponseData?.result?.startTime != "") &&
                   ...
                   /* if (hourlyDuration == 2) {
                        ...
                        *//*
                        ...
                        Toast.makeText(context!!, "hourly" + hourlyDuration, Toast.LENGTH_SHORT)
                            .show()
                    }*/
...
//            patientProfileRequest?.userId="11"
                            var deletePatientFamilyMemberRequest =
...
//            nurseSlotRequest?.userId="11"
    ...
    fun apiHitGetBookedSlots() {
        if (isNetworkConnected) {
            ...
            getSlotRequest.service_type = "babysitter"
    ...
    private fun apiHitForNurseBookingAppointment() {
        ...
        val symptom_text =
            fragmentNursesBookingAppointmentBinding?.edtSymptomText?.text?.toString()?.let {
                RequestBody.create(
                    "multipart/form-data".toMediaTypeOrNull(),
                    it
                )
