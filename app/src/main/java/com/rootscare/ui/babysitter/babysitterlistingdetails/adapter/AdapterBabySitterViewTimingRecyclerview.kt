...
class AdapterBabySitterViewTimingRecyclerview (val nurseTimingList: ArrayList<ResultItem?>?, internal var context: Context) : RecyclerView.Adapter<AdapterBabySitterViewTimingRecyclerview.ViewHolder>() {
    companion object {
