...
class AdapterNurseSpecilityListRecyclerview (val departmentList: ArrayList<com.rootscare.data.model.api.response.hospitalallapiresponse.hospitaldetailsresponse.DepartmentItem?>?, internal var context: Context) : RecyclerView.Adapter<AdapterNurseSpecilityListRecyclerview.ViewHolder>() {
