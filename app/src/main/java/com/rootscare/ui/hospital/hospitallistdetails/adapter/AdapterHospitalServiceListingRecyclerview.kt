...
import com.rootscare.databinding.ItemHospitalPhotoRecyclerviewBinding
import com.rootscare.databinding.ItemHospitalServiceRecyclerviewBinding
import com.interfaces.OnItemClikWithIdListener
import com.rootscare.ui.home.subfragment.adapter.AdapterHospitalRecyclerviw

class AdapterHospitalServiceListingRecyclerview  ( internal var context: Context) : RecyclerView.Adapter<AdapterHospitalServiceListingRecyclerview.ViewHolder>() {
...
//
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val singleItemDashboardListingBinding = DataBindingUtil.inflate<ItemHospitalServiceRecyclerviewBinding>(
            LayoutInflater.from(context),
            R.layout.item_hospital_service_recyclerview, parent, false)
...
//        return trainerList!!.size
    ...
    inner class ViewHolder(itemView: ItemHospitalServiceRecyclerviewBinding) : RecyclerView.ViewHolder(itemView.root) {
