...
class AdapterHospitalPhotoRecyclerView ( internal var context: Context) : RecyclerView.Adapter<AdapterHospitalPhotoRecyclerView.ViewHolder>() {
...
//
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val singleItemDashboardListingBinding = DataBindingUtil.inflate<ItemHospitalPhotoRecyclerviewBinding>(
            LayoutInflater.from(context),
            R.layout.item_hospital_photo_recyclerview, parent, false)
...
//        return trainerList!!.size
    ...
    inner class ViewHolder(itemView: ItemHospitalPhotoRecyclerviewBinding) : RecyclerView.ViewHolder(itemView.root) {
