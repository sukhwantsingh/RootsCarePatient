...
class AdapterHospitalCategoryListingRecyclerView(internal var context: Context) :
    RecyclerView.Adapter<AdapterHospitalCategoryListingRecyclerView.ViewHolder>() {
