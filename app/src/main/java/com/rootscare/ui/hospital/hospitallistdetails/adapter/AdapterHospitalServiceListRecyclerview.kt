...
class AdapterHospitalServiceListRecyclerview (val departmentList: ArrayList<com.rootscare.data.model.api.response.hospitalallapiresponse.hospitaldetailsresponse.ServiceDataItem?>?, internal var context: Context) : RecyclerView.Adapter<AdapterHospitalServiceListRecyclerview.ViewHolder>() {
