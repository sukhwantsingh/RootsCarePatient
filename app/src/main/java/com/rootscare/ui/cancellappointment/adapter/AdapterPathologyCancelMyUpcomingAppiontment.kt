...
class AdapterPathologyCancelMyUpcomingAppiontment(
    val pathologyAppointmentList: ArrayList<AppointmentItem?>?,
    internal var context: Context
) : RecyclerView.Adapter<AdapterPathologyCancelMyUpcomingAppiontment.ViewHolder>() {
...
//            itemView.rootView?.txt_appointmentcancel_time?.text = "$fromtime-$totime"
            if (pathologyAppointmentList?.get(pos)?.pathologyName != null && !pathologyAppointmentList[pos]?.pathologyName.equals(
                ...
                itemView.txt_appointmentcancel_time.text = pathologyAppointmentList[pos]!!.pathologyName
            }
